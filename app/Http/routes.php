...
//
Route::group([
    'domain' => ((config('app.env') == 'dev') ? 'api.vatusa.devel' : ((config('app.env') == 'alpha') ? 'alpha' : 'www') . '.vatusa.net'),
    'middleware' => 'api'
], function () {
...
Route::group([
    'domain' => ((config('app.env') == 'dev') ? 'vatusa.devel' : ((config('app.env') == 'alpha') ? 'alpha' : 'www') . '.vatusa.net'),
